...
namespace Bedrock.DomainBuilder.EntityFramework
{
    ...
    public static class Accessibility
    {
        ...
        public static string ForNavigationProperty(NavigationProperty navProp)
        {
            ...
            var typeAccess = Accessibility.ForType(endType);
        ...
        private static void CalculatePropertyAccessibility(MetadataItem item, out string propertyAccessibility, out string getterAccessibility, out string setterAccessibility)
        {
